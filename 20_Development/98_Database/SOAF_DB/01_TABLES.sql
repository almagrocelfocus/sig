...
--------------------------------------------------------
--  DDL for Table SOAF_ERROR_MASKING
-------------------------------------------------------- 
   CREATE TABLE "SOAF_ERROR_MASKING" 
   (	"ID" NUMBER, 
	"DOMAIN" VARCHAR2(250 BYTE), 
	"CATEGORY" VARCHAR2(250 BYTE), 
	"TARGET" VARCHAR2(250 BYTE), 
	...
	"RESPONSE_CODE_MASK" VARCHAR2(250 BYTE), 
	"RESPONSE_MSG_MASK" VARCHAR2(250 BYTE), 
	"ERROR_CODE_MASK" VARCHAR2(250 CHAR), 
	"ERROR_MSG_MASK" VARCHAR2(500 CHAR), 
	"CREATION_DATE" TIMESTAMP (6), 
	"CREATION_BY" VARCHAR2(250 CHAR), 
	"LAST_UPDATE_DATE" TIMESTAMP (6), 
	"LAST_UPDATE_BY" VARCHAR2(250 CHAR)
   );
   
   CREATE UNIQUE INDEX "SOAF_ERROR_MASKING_PK" ON "SOAF_ERROR_MASKING" ("ID") ;