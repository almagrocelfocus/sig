		...
		<log:input>
			...
			<log:level>
                        ...
                        <log:dynamicKeys>
                        {
                                       ...
                                       for $pathDynamicKeyHeader in $headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_KEY_ADAPTER_START']
                                        return
                                          if ($pathDynamicKeyHeader/he:value[1]/text() != $headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_HIDE_ADAPTER_START']/he:value[1]/text()) then
                                  ...
                                  {
                                       if (fn:not(fn:empty($headerInner))) then
                                       for $pathDynamicKeyHeader in $headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_KEY_ADAPTER_START']
                                        return
                                          if ($pathDynamicKeyHeader/he:value[1]/text() != $headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_HIDE_ADAPTER_START']/he:value[1]/text()) then
                                            let $dynamicLogHeader := local:evalPathImpl(tokenize($pathDynamicKeyHeader/he:value[1]/text(), "/"), local:strip-ns($headerInner))
                                            return
			...
			<log:description>Invoking target system</log:description>
			...
			{ 
				for $targetRequestId in $headerExtended/he:contextInformation[1]/he:requestorIp[1]
				return 
			...
			<log:payload>
				<soap-env:Header>
                                  {
                                    if (fn:not(fn:empty($headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_HIDE_ADAPTER_START'])) and fn:not(fn:empty($headerInner))) then
                                       for $pathToHideHeader in $headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_HIDE_ADAPTER_START']
                                        return   
				...
				<soap-env:Body>
                                 {
                                    if (fn:not(fn:empty($headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_HIDE_ADAPTER_START'])) and fn:not(fn:empty($bodyInner))) then
                                       for $pathToHideBody in $headerExtended/he:attributeList[1]/he:attribute[he:name='LOG_HIDE_ADAPTER_START']
                                        return   
